  ...
  <div class="table_container">
    ...
    <div class="table_list">
      ...
      >
        ...
        <!--<el-table-column label="custId" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column label="successAmount" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.backTotalAmount }}</span>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      ...
      backDetailExport(_this.queryConditions)
        .then((res) => {
    ...
    getListItem() {
      ...
      // 分页逻辑
      backDetailQuery(_this.queryConditions)
        .then((res) => {
