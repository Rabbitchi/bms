  ...
  <div class="table_container">
      ...
      <el-form :inline="true" :model="queryConditions.data" ref="rateTable">
        <el-row>
          <el-col :span="24">
            ...
            <el-form-item label="loanTerm:" prop="loanTerm">
              <el-select
    ...
    <div class="table_list">
      ...
      >
        ...
        <el-table-column label="successAmount" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.successAmount }}</span>
          </template>
        </el-table-column>
        <el-table-column label="principal" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column label="overdueInterest" align="center">
          <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      ...
      filterTemplateHeader: [
        ...
        { name: 'paymentMethod', value: 'paymentMethod', isRequired: false },
        ...
        { name: 'successAmount', value: 'backTotalAmount', isRequired: false },
        { name: 'principal', value: 'principal', isRequired: false },
  ...
  methods: {
    ...
    exportExcel() {
      ...
      // 导出
      frsRepayDetailExport(_this.queryConditions)
        .then((res) => {
    ...
    getListItem() {
      ...
      // 分页逻辑
      frsRepayDetailQuery(_this.queryConditions)
        .then((res) => {
