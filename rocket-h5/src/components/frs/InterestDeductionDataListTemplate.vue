  ...
  <div class="table_container">
    ...
    <div class="table_list">
      ...
      >
        ...
        <el-table-column label="interestExempt" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.interestExempt }}</span>
          </template>
        </el-table-column>
      </el-table>
      <pagination
...
import { interestExemptQuery, interestExemptExport } from '@/api/frs/finance'
...
export default {
  ...
  data() {
    return {
      ...
      filterTemplateHeader: [
        ...
        { name: 'interestExempt', value: 'interestExempt', isRequired: false }
      ],
      //时间控件修改，限制只能选同一年
      minDate: '',
      maxDate: '',
  ...
  methods: {
    ...
    exportExcel() {
      ...
      interestExemptExport(_this.queryConditions)
        .then((res) => {
    ...
    getListItem() {
      ...
      // 分页逻辑
      interestExemptQuery(_this.queryConditions)
        .then((res) => {
