  ...
  <div class="table_container">
    ...
    <div class="table_list">
      ...
      >
        ...
        <el-table-column label="paymentAmount" align="center">
          <template slot-scope="scope">
...
import { notCreditedQuery, notCreditedExport } from '@/api/frs/finance'
...
export default {
  ...
  data() {
    return {
      ...
      filterTemplateHeader: [
        ...
        { name: 'paymentAmount', value: 'amount', isRequired: false },
  ...
  methods: {
    ...
    exportExcel() {
      ...
      notCreditedExport(_this.queryConditions)
        .then((res) => {
    ...
    getListItem() {
      ...
      // 分页逻辑
      notCreditedQuery(_this.queryConditions)
        .then((res) => {
