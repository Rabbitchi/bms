  ...
  ADD_VISITED_VIEW: (state, view) => {
    ...
    state.visitedViews.push(
      Object.assign({}, view, {
        ...
        secondTitle:
          (view.query && view.query.title && ' - ' + view.query.title) || ''
      })
    )
  },
...
const actions = {
  ...
  refreshCurrentView({ dispatch, commit }, params) {
    dispatch('delCachedView', params.view).then(() => {
      const { fullPath } = params.view
